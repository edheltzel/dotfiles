...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Fira Code"
                               :size 18
                               :weight normal
                               :width norFiraCodeNerdFontComplete-Retinamal
                               :powerline-scale 1.1)
   ;; The leader key
